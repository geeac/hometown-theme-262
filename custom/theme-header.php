...
<style type="text/css">
	...
	/* BG Color */
	.primary-nav > ul > li.bubble a, .lt-button.primary, input.primary[type='submit'], .rangeSlider .noUi-connect, .map-wrap .marker .dot, .map-wrap .marker:after, .map-wrap .cluster:before, .map-wrap .cluster:after, .card .status:before, .hero .status:before, .property-hero .status:before, #nprogress .bar, .button:hover, input[type='submit']:hover, input[type='button']:hover, .lt-button:hover  { background-color: <?php echo nt_get_option('appearance', 'site_color'); ?>; }
	::selection { background-color: <?php echo nt_get_option('appearance', 'site_color'); ?>; }
	::-moz-selection { background-color: <?php echo nt_get_option('appearance', 'site_color'); ?>; }
	...
	/* Border */
	.primary-nav > ul > li > ul.sub-menu, #nprogress .spinner-icon, .lt-button.primary, input.primary[type='submit'], .button:hover, input[type='submit']:hover, input[type='button']:hover, .lt-button:hover { border-color: <?php echo nt_get_option('appearance', 'site_color'); ?>; }
