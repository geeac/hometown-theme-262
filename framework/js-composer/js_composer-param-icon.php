...
function icon_param_settings_field($settings, $value) {
   ...
   return '<div class="nt_icon_block">'
             ...
             .$value.'" ' . $dependency . '/><div class="cur-icon">'.$cur_icon.'</div><div class="icons-select">select icon<i class="nt-icon-angle-down"></i></div><div style="clear: both;"></div>'.$icon_list
         .'</div>';
}
add_shortcode_param('nt_icon', 'icon_param_settings_field');