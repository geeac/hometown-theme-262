...
function nt_admin_scripts( $page ) {
	...
	// Location Picker
	wp_enqueue_script('nt-google-map', 'http://maps.google.com/maps/api/js?sensor=false&libraries=places', false, THEME_VERSION, true);
	...
	// Admin JS
	wp_enqueue_script('nt-admin-less', THEME_FRAMEWORK_ASSETS_URI . '/js/less-1.6.3.min.js', false, THEME_VERSION, true );
	wp_enqueue_script('nt-admin', THEME_FRAMEWORK_ASSETS_URI . '/js/admin.js', false, THEME_VERSION, true );
	// wp_enqueue_script('nt-admin-custom-vc', THEME_FRAMEWORK_ASSETS_URI . '/js/custom-vc.js', false, THEME_VERSION, true );
}
