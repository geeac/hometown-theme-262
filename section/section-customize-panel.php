	...
	jQuery(document).ready(function($) {
		...
		$('#primary-color-custom').iris({
		    ...
		    change: function(event, ui) {
		        ...
		        // Background
		        $(document).contents().find('head').append('<style type="text/css">.primary-nav > ul > li.bubble a, .lt-button.primary, input.primary[type="submit"], .rangeSlider .noUi-connect, .map-wrap .marker .dot, .map-wrap .marker:after, .map-wrap .cluster:before, .map-wrap .cluster:after, .card .status:before, .hero .status:before, .property-hero .status:before, #nprogress .bar, ::selection, .button:hover, input[type="submit"]:hover, input[type="button"]:hover, .lt-button:hover { background-color: '+ui.color.toString()+';} </style>');
		        // Border
